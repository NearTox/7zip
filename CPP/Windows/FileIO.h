...
#define my_FSCTL_SET_REPARSE_POINT \
  CTL_CODE(                        \
      FILE_DEVICE_FILE_SYSTEM, 41, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)  // REPARSE_DATA_BUFFER
#define my_FSCTL_GET_REPARSE_POINT \
...
#  define my_IOCTL_DISK_GET_DRIVE_GEOMETRY_EX \
 ...
 public:
  ...
  bool OpenReparse(CFSTR fileName) {
    ...
    return Create(
        fileName, 0,
        // Open(fileName,
        FILE_SHARE_READ, OPEN_EXISTING, FILE_FLAG_OPEN_REPARSE_POINT | FILE_FLAG_BACKUP_SEMANTICS);
  }
