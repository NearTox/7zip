...
typedef UInt32(MY_FAST_CALL* CRC_FUNC)(
...
class CCrcHasher
 ...
 public:
  ...
  INTERFACE_IHasher(;) STDMETHOD(SetCoderProperties)(
...
STDMETHODIMP CCrcHasher::SetCoderProperties(
...
STDMETHODIMP_(void) CCrcHasher::Init() throw() { _crc = CRC_INIT_VAL; }
