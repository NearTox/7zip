...
#ifdef _WIN32
  HRESULT CoCreateInstance(REFCLSID rclsid, REFIID iid, LPUNKNOWN pUnkOuter = nullptr, DWORD dwClsContext = CLSCTX_ALL) {
...
(REFGUID iid, void **outObject) throw() { *outObject = nullptr;
