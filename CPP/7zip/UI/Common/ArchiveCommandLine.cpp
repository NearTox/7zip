...
static void AddSwitchWildcardsToCensor(
  ...
  for(i = 0; i < strings.Size(); i++) {
    ...
    if(name[pos] == kImmediateNameID)
      ...
      AddToCensorFromListFile(nullptr, censor, tail, include, recursedType, wildcardMatching, codePage);
#ifdef _WIN32
...
// options.ArchiveName.Replace(L'/', WCHAR_PATH_SEPARATOR);
  ...
  AddToCensorFromNonSwitchesStrings(isRename ? &options.UpdateOptions.RenamePairs : nullptr,
