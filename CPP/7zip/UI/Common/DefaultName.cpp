...
static UString GetDefaultName3(
    const UString& fileName, const UString& extension, const UString& addSubExtension) {
  ...
  if (dotPos > 0) return fileName.Left(dotPos) + addSubExtension;
