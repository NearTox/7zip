...
namespace NCrypto {
  namespace NSha1 {
    ...
    public:
      ...
      void GetBlockDigest(const UInt32 *blockData, UInt32 *destDigest) throw() {
    ...
    public:
      void Update(const Byte *data, size_t size) throw() {
    ...
    public:
      void Update(const UInt32 *data, size_t size) throw() {
        Sha1_32_Update(&_s, data, size);
      }
      void Final(UInt32 *digest) throw() {
        Sha1_32_Final(&_s, digest);
      }
