  ...
  namespace NDeflate {
    namespace NDecoder {
      ...
      public:
        ...
        void SetNsisMode(bool nsisMode) {
          _deflateNSIS = nsisMode;
        }

        void Set_KeepHistory(bool keepHistory) {
          _keepHistory = keepHistory;
        }
        void Set_NeedFinishInput(bool needFinishInput) {
          _needFinishInput = needFinishInput;
        }

        bool IsFinished() const {
          return _remainLen == kLenIdFinished;;
        }
        ...
        UInt64 GetStreamSize() const {
          return m_InBitStream.GetStreamSize();
        }
      ...
      public: CCOMCoder() : CCoder(false) {}
      };
      class CCOMCoder64 : public CCoder {
      public: CCOMCoder64() : CCoder(true) {}
      };
    }
  }
}
