  ...
  namespace NLzx {
    ...
    public:
      ...
      bool IsOneDirectByteLeft() const {
        return _buf == _bufLim && _extraSize == 0;
      }
    ...
    public:
      ...
      bool WasBlockFinished() const {
        return _unpackBlockSize == 0;
      }
      const Byte *GetUnpackData() const {
        return _unpackedData;
      }
      const UInt32 GetUnpackSize() const {
        return _pos - _writePos;
      }
    };
  }
}
