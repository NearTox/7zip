...
HRESULT CHandler::Open2(IInStream *stream)
{
  ...
  RINOK(zlibCoder->Code(inStreamLim, outStreamLim, nullptr, nullptr, nullptr));
  ...
  for (i = 0; i < numItems; i++, currentPackTotal += currentPackSize, currentUnpTotal += currentUnpSize)
  {
    ...
    #endif
    {
      ...
      if (item.HasData)
      {
        ...
        if (coder)
          res = coder->Code(inStream, outStream, nullptr, nullptr, progress);
