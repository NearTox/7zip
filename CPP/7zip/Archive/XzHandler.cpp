...
#define k_LZMA2_Name "LZMA2"
    ...
    public:
      ...
      HRESULT SeekToPackPos(UInt64 pos) {
        return _stream->Seek(pos, STREAM_SEEK_SET, nullptr);
      }
    };
...
#define kInputBufSize ((size_t)1 << 10)
    ...
    HRESULT CHandler::Open2(IInStream *inStream, /* UInt32 flags, */ IArchiveOpenCallback *callback) {
      ...
      if(callback) {
        RINOK(callback->SetTotal(nullptr, &_stat.InSize));
      }
    ...
    CXzUnpackerCPP2::CXzUnpackerCPP2() : InBuf(nullptr)
      // , OutBuf(nullptr)
    {
    ...
    STDMETHODIMP CHandler::UpdateItems(ISequentialOutStream *outStream, UInt32 numItems,
      ...
      if(IntToBool(newData)) {
        ...
        */
        ...
        return encoderSpec->Code(fileInStream, outStream, nullptr, nullptr, progress);
      }
