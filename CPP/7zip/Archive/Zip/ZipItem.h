...
namespace NArchive {
  namespace NZip {
    ...
    public:
      ...
      bool IsUtf8() const {
        return (Flags & NFileHeader::NFlags::kUtf8) != 0;
      }
    ...
    public:
      ...
      void SetEncrypted(bool encrypted) {
        SetFlag(NFileHeader::NFlags::kEncrypted, encrypted);
      }
      void SetUtf8(bool isUtf8) {
        SetFlag(NFileHeader::NFlags::kUtf8, isUtf8);
      }
    ...
    public:
      ...
      const CExtraBlock &GetMainExtra() const {
      ...
      Byte GetHostOS() const {
        return FromCentral ? MadeByVersion.HostOS : ExtractVersion.HostOS;
      }
