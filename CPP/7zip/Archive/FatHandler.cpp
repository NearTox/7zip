...
{
  return InStream->Seek((UInt64)sector << Header.SectorSizeLog, STREAM_SEEK_SET, nullptr);
}
...
HRESULT CDatabase::OpenProgressFat(bool changeTotal)
{
  ...
  if (changeTotal)
  {
    ...
    RINOK(OpenCallback->SetTotal(nullptr, &numTotalBytes));
  }
  return OpenCallback->SetCompleted(nullptr, &NumCurUsedBytes);
}
...
static const CStatProp kArcProps[] =
{
  ...
  { nullptr, kpidId, VT_UI4},
  // { "OEM Name", kpidOemName, VT_BSTR},
  // { "Volume Name", kpidVolName, VT_BSTR},
  // { "File System Type", kpidFileSysType, VT_BSTR}
  // { nullptr, kpidSectorsPerTrack, VT_UI4},
  // { nullptr, kpidNumHeads, VT_UI4},
  // { nullptr, kpidHiddenSectors, VT_UI4}
};
