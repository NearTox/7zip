...
HRESULT CHandler::Open2(IInStream *inStream, IArchiveOpenCallback *callback)
{
  ...
  for (;;)
  {
    ...
    RINOK(inStream->Seek(pos, STREAM_SEEK_SET, nullptr));
    ...
    Int32 testMode, IArchiveExtractCallback *extractCallback)
{
  ...
  NCompress::NLzh::NDecoder::CCoder *lzhDecoderSpec = nullptr;
  CMyComPtr<ICompressCoder> lzhDecoder;

  NCompress::NArj::NDecoder::CCoder *arjDecoderSpec = nullptr;
...

    {
      ...
      else
      {
        switch (item.Method)
        {
          ...
          {
            result = copyCoder->Code(inStream, outStream, nullptr, nullptr, progress);
          ...
          case NCompressionMethod::kCompressed1c:
          {
            ...
            result = lzhDecoder->Code(inStream, outStream, nullptr, &curUnpacked, progress);
          ...
          case NCompressionMethod::kCompressed2:
          {
            ...
            result = arjDecoder->Code(inStream, outStream, nullptr, &curUnpacked, progress);
