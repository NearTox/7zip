      ...
      currentTotalPacked += currentItemPacked)
  {
...

    {
      ...
      else if (item.IsLh4GroupMethod())
      {
        ...
        res = lzhDecoder->Code(inStream, outStream, nullptr, &currentItemUnPacked, progress);
      ...
      else if (item.IsLh1GroupMethod())
      {
        ...
        res = lzh1Decoder->Code(inStream, outStream, nullptr, &currentItemUnPacked, progress);
      }
      */
      else
