...
STDMETHODIMP CHandler::GetPropertyInfo(
...
static void SetFileTimeProp_From_UInt64Def(
    PROPVARIANT* prop, const CUInt64DefVector& v, int index) {
  UInt64 value;
  if (v.GetItem(index, value)) PropVarEm_Set_FileTime64(prop, value);
}
...
STDMETHODIMP CHandler::GetProperty(UInt32 index, PROPID propID, PROPVARIANT* value) {
  ...
  */
  ...
  switch (propID) {
    ...
    case kpidAttrib:
      if (_db.Attrib.ValidAndDefined(index2)) PropVarEm_Set_UInt32(value, _db.Attrib.Vals[index2]);
      break;
    case kpidCRC:
