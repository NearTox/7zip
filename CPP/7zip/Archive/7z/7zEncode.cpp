...
namespace NArchive {
  namespace N7z {
    ...
    public:
      ...
      CSequentialOutTempBufferImp2() : _buf(0), _mtProgresSpec(nullptr) {}
    ...
    public:
      ...
      CSequentialOutMtNotify() : _mtProgresSpec(nullptr) {}
      MY_UNKNOWN_IMP1(ISequentialOutStream)
    ...
    HRESULT CEncoder::Encode(
      ...
      CMtEncMultiProgress *mtProgressSpec = nullptr;
      CMyComPtr<ICompressProgressInfo> mtProgress;

      CSequentialOutMtNotify *mtOutStreamNotifySpec = nullptr;
      ...
      for(i = 0; i < numMethods; i++)
        _mixer->SetCoderInfo(i, nullptr, nullptr, false);
      ...
      /*
      if (inStreamSize)
        _mixer->SetCoderInfo(_bindInfo.UnpackCoder, inStreamSize, nullptr);
      */

      CSequentialInStreamSizeCount2 *inStreamSizeCountSpec = new CSequentialInStreamSizeCount2;
      CMyComPtr<ISequentialInStream> inStreamSizeCount = inStreamSizeCountSpec;

      CSequentialOutStreamSizeCount *outStreamSizeCountSpec = nullptr;
