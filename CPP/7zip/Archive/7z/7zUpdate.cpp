...
#define RIFF_SIG 0x46464952
    ...
    static HRESULT WriteRange(IInStream *inStream, ISequentialOutStream *outStream,
      ...
      RINOK(copyCoder->Code(inStreamLimited, outStream, nullptr, nullptr, progress));
      ...
      try {
        ...
        Result = Decoder.Decode(
          ...
          *Folders, FolderIndex,
          ...
          // send_UnpackSize ? &UnpackSize : nullptr,
          nullptr, // unpackSize : FULL unpack
    ...
    HRESULT Update(
      ...
      */
      ...
      if(startBlockSize > 0 && !options.RemoveSfxBlock) {
        RINOK(WriteRange(inStream, seqOutStream, 0, startBlockSize, nullptr));
      }
      ...
      CCryptoGetTextPassword *getPasswordSpec = nullptr;
      CMyComPtr<ICryptoGetTextPassword> getTextPassword;
      ...
      */
      ...
      for(unsigned groupIndex = 0; groupIndex < filters.Size(); groupIndex++) {
          ...
          if(rep.NumCopyFiles == numUnpackStreams) {
            ...
            */
            ...
            UInt64 curUnpackSize;
            {
              ...
              CFolderInStream2 *FosSpec2 = nullptr;
        ...
        for(i = 0; i < numFiles;) {
          ...
          const wchar_t *prevExtension = nullptr;
