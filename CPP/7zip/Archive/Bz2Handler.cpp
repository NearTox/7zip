    ...
    Int32 testMode, IArchiveExtractCallback *extractCallback)
{
  ...
  HRESULT result = decoderSpec->Code(_seqStream, outStream, nullptr, nullptr, progress);
    ...
    IArchiveUpdateCallback *updateCallback)
{
  ...
  RINOK(props.SetCoderProps(encoderSpec, nullptr));
  RINOK(encoder->Code(fileInStream, outStream, nullptr, nullptr, localProgress));
