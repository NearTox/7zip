...
namespace NArchive {
  namespace NCab {
    ...
    struct CFolder {
      ...
      Byte GetMethod() const {
        return (Byte)(MethodMajor & 0xF);
      }
    };
    ...
    struct CItem {
      ...
      UInt64 GetEndOffset() const {
        return (UInt64)Offset + Size;
      }
      UInt32 GetWinAttrib() const {
        return (UInt32)Attributes & ~(UInt32)NHeader::kFileNameIsUtf8_Mask;
      }
      bool IsNameUTF() const {
        return (Attributes & NHeader::kFileNameIsUtf8_Mask) != 0;
      }
      bool IsDir() const {
