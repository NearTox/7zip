...
#if defined(_M_ARM) || defined(_M_ARM_NT) || defined(_M_ARMT) || defined(__arm__) ||          \
    defined(__thumb__) || defined(__ARMEL__) || defined(__ARMEB__) || defined(__THUMBEL__) || \
    defined(__THUMBEB__)
#  define MY_CPU_ARM
...
#  endif
    ...
    defined(_MIPSEL) || defined(__BFIN__) ||                                                      \
